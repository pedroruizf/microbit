...
* [* Reto 4: Animaciones con bucle while](https://create.withcode.uk/python/AJM)
* [Reto 4_2: Animaciones con bucle while y array ](https://create.withcode.uk/python/AJN)
* [Reto 4_3: Animaciones  con while, array y sleep](https://create.withcode.uk/python/AJP)
...
* [* Reto 8: While, running_time](https://create.withcode.uk/python/AJZ)
* [* Reto 9: Bucle infinito (while True:) e if](https://create.withcode.uk/python/AJc)
* [* Reto 9_2: While con salida boolena](https://create.withcode.uk/python/CXm)
...
* [* Reto 11_2: Bucle sabiendo nº de repeticiones con While](https://create.withcode.uk/python/CYa)
...
* [* Reto 16_2: Linterna automática](https://create.withcode.uk/python/YAM)
...
* [* Reto 18: Izquierda (Left) o Derecha (Right). Jugando con el acelerómetro](https://create.withcode.uk/python/AKM)
